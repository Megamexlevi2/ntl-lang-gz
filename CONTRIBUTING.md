...
│   ├── pkg/                 Package manager (install/add/resolve)
│   ├── manifest/            lunex.toml / lunex.lock parsing
│   ├── buildfile/           Thin wrapper over manifest for build/start
│   ├── toml/                 Minimal TOML reader/writer
